...
dmonth = pickle.load(d_file)
d_file.close()
local_plots.plot_eve(ax,dmonth,obs_errors=None,point_color=(.5,.5,1))
...
dmonth = pickle.load(d_file)
d_file.close()
local_plots.plot_eve(ax,dmonth,obs_errors=None,point_color='black')
...
dmonth = pickle.load(d_file)
d_file.close()
local_plots.plot_eve(ax,dmonth,obs_errors=None,point_color=(.5,.5,.5))
...
dmonth = pickle.load(d_file)
d_file.close()
local_plots.plot_eve(ax,dmonth,obs_errors=None,point_color='red')
...
dmonth = pickle.load(d_file)
d_file.close()
local_plots.plot_eve(ax,dmonth,obs_errors=None,point_color=(1,.5,.5))
