...
This combines a `spaghetti-contour plot <analysis_spaghetti_contour.html>`_ and a `reanalysis-ensemble at station plot <analysis_ensemble_at_station.html>`_ into a single figure.

.. toctree::
   :maxdepth: 2

   analysis_scatter_and_contour_20CR2c
   analysis_scatter_and_contour_CERA20C
